...
const translations = {
  en: {
    live: 'Live', offline: 'Offline', inputLabel: 'Media link or share text', platformCount: '39 platforms',
    ...
    unsupportedDetail: 'Use a public media link from one of OmniMedia’s 39 supported platforms.',
  ...
  zh: {
    live: '正常', offline: '离线', inputLabel: '媒体链接或完整分享文本', platformCount: '39 个平台',
    ...
    unsupportedDetail: '请使用 OmniMedia 已支持的 39 个平台之一的公开媒体链接。',
