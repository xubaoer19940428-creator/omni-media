...
export const translations = {
  en: {
    ...
    workbench: {
      ...
      placeholder: 'Paste any post link or raw share text (TikTok, Douyin, Instagram, YouTube, X/Twitter, Bilibili...)',
      paste: 'Paste',
      clear: 'Clear',
    ...
    profile: {
      singleMode: 'Single media',
      creatorMode: 'Creator profile',
      title: 'Creator profile URL',
      placeholder: 'Paste a public creator profile link (TikTok, Instagram, YouTube, X/Twitter, Bilibili...)',
      parse: 'Parse creator',
      parsing: 'Parsing profile...',
      policy: 'Public, login-free profiles only · up to 12 posts per request · private or login-only profiles are not supported.',
      summary: 'Public profile results',
      posts: 'posts',
      followers: 'followers',
      following: 'following',
      likes: 'likes',
      website: 'Website',
      verified: 'Verified',
      parseItem: 'Parse post',
      openProfile: 'Open profile',
      loadMore: 'Load more posts',
      showing: 'Showing {count} public posts',
      noItems: 'No accessible public posts were found for this profile.',
      noUrlError: 'Please provide a public creator profile URL.',
    },
    // Result Card
    result: {
      video: 'Video Stream',
      ...
      resolveGallery: 'Expand with gallery-dl',
      galleryResolving: 'Resolving...',
  ...
  zh: {
    ...
    workbench: {
      ...
      placeholder: '支持直接粘贴 App 分享文案（例如抖音、TikTok、B站、YouTube、Instagram、X/Twitter...）',
      paste: '剪贴板粘贴',
      clear: '清空',
      extractMedia: '立即解析',
      extracting: '正在解析...',
    ...
    profile: {
      ...
      creatorMode: '个人主页',
      title: '创作者主页链接',
      placeholder: '粘贴公开的创作者主页链接（TikTok、Instagram、YouTube、X/Twitter、Bilibili…）',
      parse: '解析主页',
      parsing: '正在解析主页…',
      policy: '仅支持公开且无需登录的主页 · 每次最多返回 12 个作品 · 不支持私密或必须登录的主页。',
      summary: '公开主页结果',
      posts: '作品',
      followers: '粉丝',
      following: '关注',
      ...
      openProfile: '打开主页',
      loadMore: '加载更多作品',
      showing: '已显示 {count} 个公开作品',
      noItems: '该主页没有可访问的公开作品。',
      noUrlError: '请输入公开的创作者主页链接。',
    },
    // Result Card
    result: {
      video: '视频原画',
      ...
      resolveGallery: '用 gallery-dl 扩展图集',
      galleryResolving: '解析中...',
