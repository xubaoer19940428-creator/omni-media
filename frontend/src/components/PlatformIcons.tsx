...
const BrandPathIcon: React.FC<IconProps & { path: string; color: string }> = ({
  className = 'w-4 h-4', size, path, color, ...props
}) => (
  <svg viewBox="0 0 24 24" fill={color} className={className} width={size} height={size} {...props}>
    <path d={path} />
  </svg>
);
